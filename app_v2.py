...
def process_form():
    ...
    return render_template('form_v2.html', encoded_output=encoded_output, 
...
def detect_text():
    ...
    return render_template('form_v2.html', text_input_with_flags = text_input_with_flags,
...
def detect_text_file():
    ...
    # Encoding and returning the details of homoglyphs
    return render_template('form_v2.html', proportion_of_homoglyphs = proportion_of_homoglyphs,
